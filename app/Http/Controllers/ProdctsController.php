...
class ProdctsController extends Controller
{
    public function Index()
    {
       ...
       ->select('categories.name as categories_name','products.name as name','products.price','products.stocke','products.categories_id','products.image','products.id','products.description')
       ->get();
