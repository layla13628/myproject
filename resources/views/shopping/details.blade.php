...
<style>
        ...
        .product-details {
            ...
            padding: 20px;
            border-radius: 10px;
            box-shadow: 0 0 10px rgba(204, 24, 93, 0.1);
        }
    </style>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="product-details">
                    ...
                    <p class="text-muted mb-3">الفئة:ادوات التجميل</p>
                    ...
                    <div class="row">
                        <div class="col">
                            <button  href="{{route('shopping.cart')}}"class="btn btn-primary btn-lg">إضافة إلى السلة</button>
                            </div>
                            <div class="col">
